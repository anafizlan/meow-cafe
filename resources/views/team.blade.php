...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,7₀;₀,8₀;₀,9₀;₁,1₀;₁,2₀;₁,3₀;₁,4₀;₁,5₀;₁,6₀;₁,7₀;₁,8₀;₁,9₀&display=swap" rel="stylesheet">
...
<body class="team-page">
  ...
  <main class="main">
    ...
    <!-- Page Title -->
    <div class="page-title dark-background" data-aos="fade" style="background-image: url({{ asset('assets/img/team-page-title.jpg') }});">
      <div class="container">
        <h1>Team</h1>
